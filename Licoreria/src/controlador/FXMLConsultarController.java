        ...
        try {
            ...
            while(rs.next()){
                if(rs.getBoolean("tipo")){
                    ...
                    oblist.add(new Empleado(rs.getString("numTrabajador"),rs.getString("nombre"),rs.getString("apellidos"),rs.getString("contraseña"),"Común"));
                }
            }
            ...
            col_contraseña.setCellValueFactory(new PropertyValueFactory("contraseña"));
